...
from MeenaX import app
from MeenaX.core.call import Meena
from MeenaX.misc import db
from MeenaX.utils.database import get_authuser_names, get_cmode
from MeenaX.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from MeenaX.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Meena.stop_stream(message.chat.id)
    except:
        pass
