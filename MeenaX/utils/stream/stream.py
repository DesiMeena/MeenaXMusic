...
import config
from MeenaX import Carbon, YouTube, app
from MeenaX.core.call import Meena
from MeenaX.misc import db
from MeenaX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from MeenaX.utils.exceptions import AssistantErr
from MeenaX.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from MeenaX.utils.inline.playlist import close_markup
from MeenaX.utils.pastebin import Meenabin
from MeenaX.utils.stream.queue import put_queue, put_queue_index
from MeenaX.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Meena.force_stop_stream(chat_id)
